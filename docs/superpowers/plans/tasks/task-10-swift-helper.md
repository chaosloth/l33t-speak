# Task 10: macOS Swift Helper

**Files:**
- Create: `helpers/macos/main.swift`
- Create: `helpers/macos/build.sh`

---

- [ ] **Step 1: Create `helpers/macos/main.swift`**
...
- [ ] **Step 2: Create `helpers/macos/build.sh`**
...
- [ ] **Step 3: Make build script executable and compile**

Run: `chmod +x helpers/macos/build.sh && ./helpers/macos/build.sh`
Expected: `bin/darwin/dictation-helper` binary is created

- [ ] **Step 4: Commit**

```bash
git add helpers/macos/main.swift helpers/macos/build.sh bin/darwin/dictation-helper
git commit -m "feat: add macOS Swift helper for speech recognition"
```
